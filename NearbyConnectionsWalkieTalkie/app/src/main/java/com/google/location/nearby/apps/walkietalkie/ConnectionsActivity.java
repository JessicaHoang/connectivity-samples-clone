...
public abstract class ConnectionsActivity extends AppCompatActivity {
    ...
    private final ConnectionLifecycleCallback mConnectionLifecycleCallback =
            new ConnectionLifecycleCallback() {
                ...
                public void onConnectionInitiated(String endpointId, ConnectionInfo connectionInfo) {
                    ...
                    Log.e("TEST", ">>> ConnectionsActivity onConnectionInitiated fired");
                ...
                public void onConnectionResult(String endpointId, ConnectionResolution result) {
                    Log.e("TEST", ">>> ConnectionsActivity onConnectionResult fired");
    ...
    protected void startAdvertising() {
        Log.e("TEST", ">>> startAdvertising() called");
        mIsAdvertising = true;
    ...
    protected void acceptConnection(final Endpoint endpoint) {
        mConnectionsClient
                .acceptConnection(endpoint.getId(), getPayloadCallback())
                .addOnFailureListener(
                        new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
    ...
    protected void startDiscovering() {
        Log.e("TEST", ">>> startDiscovering() called");
        mIsDiscovering = true;
    ...
    protected abstract void onTransferUpdate(
